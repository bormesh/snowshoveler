...
from snowshoveler.model import message, session, user
from snowshoveler.model.user import PasswordHistory as password_history

from snowshoveler.model import numberoffailedloginattemps as loginattempt
from snowshoveler.webapp.auth import scrubbers


log = logging.getLogger(__name__)

module_template_prefix = 'auth'
module_template_package = 'snowshoveler.webapp.auth.authtemplates'
